  ...
  describe '.query_options' do
    ...
    context 'when invalid option is passed' do
      ...
      it 'raises runtime error' do
        expect {  ExchangerateHost::Endpoints::TimeSeries.query_options(invalid_option) }.to raise_error(RuntimeError, /Invalid options\/values detected/)
      end
    end
    ...
    context 'when required option is missing' do
      ...
      it 'raises runtime error' do
        expect {  ExchangerateHost::Endpoints::TimeSeries.query_options(missing_option) }.to raise_error(RuntimeError, /Missing required options/)
      end
    end
  end
end
