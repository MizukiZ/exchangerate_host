  ...
  describe '.query_options' do
    ...
    context 'when invalid option is passed' do
      ...
      it 'raises runtime error' do
        expect { Endpoints::ConvertCurrency.query_options(invalid_option) }.to raise_error(RuntimeError)
      end
    end
    ...
    context 'when required option is missing' do
      ...
      it 'raises runtime error' do
        expect { Endpoints::ConvertCurrency.query_options(missing_option) }.to raise_error(RuntimeError)
      end
    end
    ...
    context 'when invalid date format is passed' do
      ...
      it 'raises runtime error' do
        expect { Endpoints::ConvertCurrency.query_options(invalid_date_format_option) }.to raise_error(RuntimeError)
      end
    end
    ...
    context 'when invalid date is passed' do
      ...
      it 'raises date error' do
        expect { Endpoints::ConvertCurrency.query_options(invalid_date_option) }.to raise_error(Date::Error)
      end
    end
  end
end
