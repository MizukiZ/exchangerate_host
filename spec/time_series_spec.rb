  ...
  describe '.query_options' do
    ...
    context 'when invalid option is passed' do
      ...
      it 'raises runtime error' do
        expect { Endpoints::TimeSeries.query_options(invalid_option) }.to raise_error(RuntimeError)
      end
    end
    ...
    context 'when required option is missing' do
      ...
      it 'raises runtime error' do
        expect { Endpoints::TimeSeries.query_options(missing_option) }.to raise_error(RuntimeError)
      end
    end
  end
end
