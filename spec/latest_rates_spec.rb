RSpec.describe ExchangerateHost::Endpoints::LatestRates do
  describe '.query_options' do
    ...
    it 'overwrites default options with given options' do
      ...
      expect(ExchangerateHost::Endpoints::LatestRates.query_options(options)).to eq({ base: 'AUD', symbols: 'AUD,USD', places: 4 })
    end
